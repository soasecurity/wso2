...
import org.soasecurity.wso2.oauth2.openam.extended.cookie.grant.internal.OpenAMCookieGrantServiceComponent;
...
public class OpenAMCookieGrantHandler extends AbstractAuthorizationGrantHandler  {
    ...
    private String defaultDomainName = "PRIMARY";

    private boolean ignoreSslValidation = true;

    private String sessionInfoUrl = "http://localhost:8080/openam/json/realms/root/sessions/?_action=getSessionInfo";

    private String openAM13SessionInfoUrl = null;
    ...
    public void init() throws IdentityOAuth2Exception {
        ...
        String openamUrl = System.getenv("openam_server_url");
    ...
    public boolean validateGrant(OAuthTokenReqMessageContext oAuthTokenReqMessageContext)  throws IdentityOAuth2Exception {
        ...
        if(cookie != null) {
            ...
            if (username != null) {
                ...
                setScopes(oAuthTokenReqMessageContext);
                authStatus = true;
            }
        } else {
    ...
    private void setScopes(OAuthTokenReqMessageContext oAuthTokenReqMessageContext) throws IdentityOAuth2Exception {

        RealmService realmService = OpenAMCookieGrantServiceComponent.getRealmService();
        try {

            String tenantDomain = oAuthTokenReqMessageContext.getAuthorizedUser().getTenantDomain();
            int tenantId = realmService.getTenantManager().getTenantId(tenantDomain);
            String[] roles = realmService.getTenantUserRealm(tenantId).getUserStoreManager().
                    getRoleListOfUser(oAuthTokenReqMessageContext.getAuthorizedUser().getUserName());
            oAuthTokenReqMessageContext.setScope(roles);
